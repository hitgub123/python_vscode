...
def addORupdate(request, id):
    if request.method == "GET":
        ...
        if (id == 0):
            return render(request, "form_update.html", {'form': ProductForm(), 'obj': {'id': id}})
         # 获取单个对象
        ...
        return render(request, "form_update.html", {'form': form, 'obj': {'id': id, 'pic': obj['pic']}})
    # print(request.GET)
    # print(id)
    ...
    if form_obj.is_valid():
       ...
       # 有上传文件就更新db的pic字段
        ...
        return render(request, "form_update.html", datamap)
